...
client.on("message", async message => {
  ...
  if(command === "say") {
    if(!message.member.roles.some(r=>["☄️ Galaxy CEO ☄️", "⚙️ Head-Support ⚙️"].includes(r.name)) )
  ...
  if(command === "ban") {
    ...
    if(!message.member.roles.some(r=>["⚙️ Head-Support ⚙️", "☄️ Galaxy CEO ☄️"].includes(r.name)) )
